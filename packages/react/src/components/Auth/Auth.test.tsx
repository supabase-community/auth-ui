...
describe('#Auth', () => {
    ...
    describe('sign in', () => {
      ...
      describe('view switch', () => {
        ...
        it('allows to switch to Magic Link view', () => {
          ...
          userEvent.click(
            screen.getByRole('link', { name: /send a magic link email/i })
          )
          expect(
            screen.getByRole('button', {
  ...
  describe('social provided auth view', () => {
    it('renders all social providers buttons and and a relevant auth form ', () => {
      render({ providers: socialProviders })

      socialProviders.forEach((provider) => {
        expect(
          screen.getByRole('button', {
            name: `Sign in with ${capitalize(provider)}`,
          })
        ).toBeInTheDocument()
      })
    ...
    it('renders only social providers buttons', () => {
      render({ providers: socialProviders, onlyThirdPartyProviders: true })
